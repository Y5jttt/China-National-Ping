...
type Config struct {
	...
	Chinamap   map[string]map[string]map[string][]string
	Toollimit  int
	Authiplist string
	Password   string
}
...
type ProvinceDetail struct {
	...
	Ctcc     map[string][]IPDetail `json:"ctcc,omitempty"`
	Cucc     map[string][]IPDetail `json:"cucc,omitempty"`
	Cmcc     map[string][]IPDetail `json:"cmcc,omitempty"`
}
